# Generated by Django 3.2.13 on 2022-06-18 04:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.PositiveSmallIntegerField(choices=[(4, 'MINIPROGRAM'), (0, 'OTHER'), (1, 'SERVICEAPP'), (2, 'SUBSCRIBEAPP')], default=1, verbose_name='type')),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'unique_together': {('app', 'alias'), ('unionid', 'app'), ('app', 'openid')},
            },
        ),
        migrations.CreateModel(
            name='Session',
        ...
        migrations.AlterIndexTogether(
            name='messagehandler',
            index_together={('app', 'weight', 'created_at')},
        ),
        migrations.CreateModel(
            name='Article',
            fields=[
